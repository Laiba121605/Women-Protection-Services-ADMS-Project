...
-- Trigger 2: Auto-set completion time when assignment status changes to Arrived
...
-- Trigger 3: When assignment is completed, mark linked incident as Arrived
...
-- Trigger 4: When a new request is logged, mark that dispatcher as unavailable
...
-- Trigger 5: When an incident is resolved, free up dispatcher if no pending incidents remain
