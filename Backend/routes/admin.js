...
// Admin can edit every table EXCEPT Admin (to prevent privilege escalation)
...
// Dashboard-friendly versions of the /system/* routes above.
// The existing /system/claim-priority etc. remain unchanged.
// ======================================================
...
//
// Schema: Password_Recovery(Recovery_id, User_email, Admin_id,
//                            Status, Request_time, Response_time, Note)
// Status values: 'Pending' | 'Processed'
//
// Only the assigned admin (Admin_id = req.user.id) can reset a password.
// Any admin can delete a request.
// The actual public /forgot and user-facing routes live in passwordRecovery.js.
// ======================================================

// GET all recovery requests with enriched user + admin names
...
// GET only this admin's assigned requests
...
// Only the admin assigned to this request can do this.
// Generates a random 12-char hex password, hashes it, updates User.Password,
// and marks the request Processed with a Response_time timestamp.
router.put('/recovery/:id/reset-password', async (req, res) => {
    ...
    try {
        ...
        const newPassword    = crypto.randomBytes(6).toString('hex'); // 12-char hex
...
// DELETE — remove a recovery request (any admin can delete)
...
router.put('/dispatcher/:id/availability', async (req, res) => {
    ...
    // Block setting offline if dispatcher has active incidents or assignments
    if (availability === 'No') {
...
// PUT — reassign an incident to a different dispatcher
...
// ======================================================
// 🔹 DASHBOARD: LAW FIRMS (for dispatcher dropdown)
// Returns all hardcoded firms merged with any extras from DB
// ======================================================
...
// ======================================================
// 🔹 DASHBOARD: REFERRED CENTRES (for dispatcher follow-up dropdown)
// Returns all hardcoded centres merged with any extras from DB
// ======================================================
